_base_ = [
    '../../VideoKNet/configs/_base_/datasets/office_panoptic.py',
    '../../../configs/_base_/default_runtime.py',
    # '../../VideoKNet/configs/_base_/schedules/schedule_1x.py',
]  # TODO: mmdet::

data_root = r'E:\Data\_original_data\1114\OFFICE_COCO'
...
num_things_classes = 51
num_stuff_classes = 10
...
test_pipeline = [
    dict(
        ...
        backend_args=_base_.backend_args,
        imdecode_backend='pillow'),
    dict(type='Resize', scale=(1024, 512), keep_ratio=True, backend='pillow'),
    dict(
        type='LoadPanopticAnnotations',
        backend_args=_base_.backend_args,
        imdecode_backend='pillow'),
